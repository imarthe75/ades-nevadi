        ...
        <form [formGroup]="tareaForm">
          <div class="field-grid">
            ...
            <div class="field">
              ...
              <p-datepicker formControlName="fechaEntrega" dateFormat="dd/mm/yy" [showIcon]="true" ariaLabel="Fecha de Entrega" />
            </div>
...
export class CrearTareaDesdeplanneacionComponent implements OnInit, OnDestroy {
    ...
    this.apiService.get<any>(`/planeacion/${planeacion.planeacion_id}/detalles`)
      ...
      .subscribe(
        res => {
          ...
          this.notify.success('Planeación seleccionada', `${(res as any).cantidad_aprendizajes} aprendizajes esperados`);
        },
        err => {
  ...
  guardarTarea() {
    ...
    this.apiService.post<unknown>('/planeacion/tareas/desde-planeacion', body)
      ...
      .subscribe(
        res => {
          this.notify.success('✅ Tarea guardada', 'Aprendizajes esperados heredados automáticamente');
