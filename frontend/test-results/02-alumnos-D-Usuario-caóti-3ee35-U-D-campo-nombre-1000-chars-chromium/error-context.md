...
- Name: 02-alumnos.spec.ts >> D. Usuario caótico — inputs extremos >> ALU-D | campo nombre: 1000 chars
  ...
  - dialog "Nuevo Alumno" [ref=e738]:
    ...
    - generic [ref=e748]:
      - generic [ref=e750]:
        ...
        - 'textbox "Ej: Juan Carlos" [active] [ref=e752]': HjlqTVPiZhcDooiRGXXzmrOoDzvRWJhSYyrpfCKgUfrrMXvrKFfmpCPyehEHYadzNvKnnssaNTqzkqAfBRjjzrtNmjTNSBzVuHCC
        - generic [ref=e753]: ℹ️ Nombre completo del alumno (se permiten hasta 100 caracteres)
        - generic [ref=e754]: 100 / 100 caracteres
      - generic [ref=e756]:
      ...
      - generic [ref=e768]:
        ...
        - textbox "AAAA999999HAAAAA01" [ref=e770]
        - generic [ref=e771]: "ℹ️ 18 caracteres: 4 letras + 6 dígitos fecha + 1 sexo (H/M/X) + 5 letras + 1 letra/dígito + 1 dígito verificador"
        - generic [ref=e772]: 0 / 18 caracteres
      - paragraph [ref=e773]: Una vez creado podrás completar el expediente completo desde el perfil.
    - button "Crear alumno" [disabled] [ref=e776]:
      - generic [ref=e777]: Crear alumno
```
