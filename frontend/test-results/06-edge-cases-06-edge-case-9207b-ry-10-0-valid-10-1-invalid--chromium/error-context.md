...
- Name: 06-edge-cases.spec.ts >> 06-edge-cases — Concurrent, RBAC, Network, Timeouts >> D3: Calificación boundary: 10.0 (valid), 10.1 (invalid)
- Location: e2e/tests/06-edge-cases.spec.ts:264:7
...
Call log:
  - waiting for locator('input[data-testid="grade-input"]')
