...
- Name: 02-alumnos.spec.ts >> D. Usuario caótico — inputs extremos >> ALU-D | campo nombre: Path traversal
  ...
  - dialog "Nuevo Alumno" [ref=e738]:
    ...
    - generic [ref=e748]:
      - generic [ref=e750]:
        ...
        - 'textbox "Ej: Juan Carlos" [active] [ref=e752]': etcpasswd
        - generic [ref=e753]: ℹ️ Nombre completo del alumno (se permiten hasta 100 caracteres)
        - generic [ref=e754]: 9 / 100 caracteres
      - generic [ref=e756]:
