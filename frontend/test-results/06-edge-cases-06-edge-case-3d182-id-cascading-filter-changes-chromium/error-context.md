...
- Name: 06-edge-cases.spec.ts >> 06-edge-cases — Concurrent, RBAC, Network, Timeouts >> E3: Rapid cascading filter changes
- Location: e2e/tests/06-edge-cases.spec.ts:365:7
...
Call log:
  - waiting for locator('select[name="nivel"]')
