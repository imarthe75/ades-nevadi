-- =============================================================================
-- ADES — Seed 002 CORREGIDO: Grupos y Profesores
...
-- D1. Primaria — titular cubre materias excepto inglés
...
INSERT INTO ades_personas
  (nombre, apellido_paterno, apellido_materno, curp, genero)
VALUES ('Administrador','Instituto','Nevadi','XEADM000000HDFNNN01A','M')
ON CONFLICT (curp) DO NOTHING;
...
CROSS JOIN ades_estatus est
WHERE per.curp = 'XEADM000000HDFNNN01A'
