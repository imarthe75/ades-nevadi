...
-- DDL PostgreSQL 18 — Migración 001: Esquema inicial completo
-- Convertido desde Oracle + gaps corregidos + tablas nuevas
-- PK: UUID NOT NULL DEFAULT uuidv7() en todas las tablas
-- FK: columnas _id son de tipo UUID referenciando id UUID de tabla padre
-- =============================================================================
...
COMMENT ON COLUMN ades_estatus.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_paises.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_estados.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_municipios.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_tipos_asentamiento.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_localidades (
    ...
    municipio_id             UUID         NOT NULL REFERENCES ades_municipios(id),
...
COMMENT ON COLUMN ades_localidades.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_codigos_postales (
    ...
    localidad_id         UUID         NOT NULL REFERENCES ades_localidades(id),
    municipio_id         UUID         NOT NULL REFERENCES ades_municipios(id),
    estado_id            UUID         NOT NULL REFERENCES ades_estados(id),
    tipo_asentamiento_id UUID         REFERENCES ades_tipos_asentamiento(id),
    ref                  UUID        NOT NULL DEFAULT uuidv7() UNIQUE,
...
COMMENT ON COLUMN ades_codigos_postales.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_direcciones (
    ...
    localidad_id         UUID         REFERENCES ades_localidades(id),
    codigo_postal_id     UUID         REFERENCES ades_codigos_postales(id),
...
COMMENT ON COLUMN ades_direcciones.id IS 'Llave primaria UUID generada por uuidv7().';
COMMENT ON COLUMN ades_direcciones.entidad_id IS 'FK polimórfica; almacena el id UUID de la entidad referenciada (PLANTEL, PERSONA, ESCUELA).';
...
COMMENT ON COLUMN ades_telefonos.id IS 'Llave primaria UUID generada por uuidv7().';
COMMENT ON COLUMN ades_telefonos.entidad_id IS 'FK polimórfica; almacena el id UUID de la entidad referenciada.';
...
COMMENT ON COLUMN ades_correos_electronicos.id IS 'Llave primaria UUID generada por uuidv7().';
COMMENT ON COLUMN ades_correos_electronicos.entidad_id IS 'FK polimórfica; almacena el id UUID de la entidad referenciada.';
...
COMMENT ON COLUMN ades_archivos.id IS 'Llave primaria UUID generada por uuidv7().';
COMMENT ON COLUMN ades_archivos.entidad_id IS 'FK polimórfica; almacena el id UUID de la entidad referenciada.';
...
COMMENT ON COLUMN ades_identidad_institucional.id IS 'Llave primaria UUID generada por uuidv7().';
SELECT auditoria.asignar_trigger('ades_identidad_institucional');

CREATE TABLE ades_historico_identidad (
    id                       UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    identidad_id             UUID         NOT NULL REFERENCES ades_identidad_institucional(id),
    valor_anterior           TEXT,
...
COMMENT ON COLUMN ades_historico_identidad.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_escuelas (
    ...
    identidad_institucional_logo_id  UUID REFERENCES ades_identidad_institucional(id),
    identidad_institucional_slogan_id UUID REFERENCES ades_identidad_institucional(id),
...
COMMENT ON COLUMN ades_escuelas.id IS 'Llave primaria UUID generada por uuidv7().';
SELECT auditoria.asignar_trigger('ades_escuelas');

CREATE TABLE ades_planteles (
    id                   UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    nombre_plantel       VARCHAR(100) NOT NULL,
    escuela_id           UUID         NOT NULL REFERENCES ades_escuelas(id),
...
COMMENT ON COLUMN ades_planteles.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_niveles_educativos.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_plantel_niveles.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_grados.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_ciclos_escolares.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_periodos_evaluacion.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_calendario_escolar.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_materias.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_materias_plan (
    ...
    grado_id             UUID         NOT NULL REFERENCES ades_grados(id),
    ciclo_escolar_id     UUID         NOT NULL REFERENCES ades_ciclos_escolares(id),
...
COMMENT ON COLUMN ades_materias_plan.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_temas.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_roles.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_personas.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_usuarios (
    ...
    rol_id               UUID         NOT NULL REFERENCES ades_roles(id),
    plantel_id           UUID         REFERENCES ades_planteles(id), -- NULL = acceso global
    estatus_id           UUID         REFERENCES ades_estatus(id),
...
COMMENT ON COLUMN ades_usuarios.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_profesores.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_disponibilidad_docente.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_estudiantes.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_contactos_familiares.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_grupos (
    ...
    grado_id             UUID         NOT NULL REFERENCES ades_grados(id),
    ciclo_escolar_id     UUID         NOT NULL REFERENCES ades_ciclos_escolares(id),
    profesor_titular_id  UUID         REFERENCES ades_profesores(id), -- solo primaria
...
COMMENT ON COLUMN ades_grupos.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_asignaciones_docentes.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_inscripciones.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_aulas.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_horarios (
    ...
    materia_id           UUID         NOT NULL REFERENCES ades_materias(id),
    profesor_id          UUID         NOT NULL REFERENCES ades_profesores(id),
    aula_id              UUID         REFERENCES ades_aulas(id),
    ciclo_escolar_id     UUID         NOT NULL REFERENCES ades_ciclos_escolares(id),
    dia_semana           SMALLINT     NOT NULL, -- 1=Lunes … 5=Viernes
    hora_inicio          TIME         NOT NULL,
    hora_fin             TIME         NOT NULL,
...
COMMENT ON COLUMN ades_horarios.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_clases (
    id                   UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    horario_id           UUID         REFERENCES ades_horarios(id),
    grupo_id             UUID         NOT NULL REFERENCES ades_grupos(id),
    materia_id           UUID         NOT NULL REFERENCES ades_materias(id),
    profesor_id          UUID         NOT NULL REFERENCES ades_profesores(id),
...
COMMENT ON COLUMN ades_clases.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_asistencias (
    id                   UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    clase_id             UUID         NOT NULL REFERENCES ades_clases(id),
    estudiante_id        UUID         NOT NULL REFERENCES ades_estudiantes(id),
...
COMMENT ON COLUMN ades_asistencias.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_planeacion_clases (
    id                       UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    grupo_id                 UUID         NOT NULL REFERENCES ades_grupos(id),
    tema_id                  UUID         NOT NULL REFERENCES ades_temas(id),
...
COMMENT ON COLUMN ades_planeacion_clases.id IS 'Llave primaria UUID generada por uuidv7().';
SELECT auditoria.asignar_trigger('ades_planeacion_clases');

CREATE TABLE ades_avance_planificacion (
    id                       UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    planeacion_clase_id      UUID         NOT NULL REFERENCES ades_planeacion_clases(id),
...
COMMENT ON COLUMN ades_avance_planificacion.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_tareas (
    ...
    grupo_id             UUID         NOT NULL REFERENCES ades_grupos(id),
    materia_id           UUID         NOT NULL REFERENCES ades_materias(id),
    tema_id              UUID         REFERENCES ades_temas(id),
...
COMMENT ON COLUMN ades_tareas.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_tareas_entregas (
    id                   UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    tarea_id             UUID         NOT NULL REFERENCES ades_tareas(id),
    estudiante_id        UUID         NOT NULL REFERENCES ades_estudiantes(id),
...
COMMENT ON COLUMN ades_tareas_entregas.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_rubricas.id IS 'Llave primaria UUID generada por uuidv7().';
SELECT auditoria.asignar_trigger('ades_rubricas');

CREATE TABLE ades_rubrica_criterios (
    id                   UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    rubrica_id           UUID         NOT NULL REFERENCES ades_rubricas(id),
...
COMMENT ON COLUMN ades_rubrica_criterios.id IS 'Llave primaria UUID generada por uuidv7().';
SELECT auditoria.asignar_trigger('ades_rubrica_criterios');

CREATE TABLE ades_calificaciones_tareas (
    id                   UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    tarea_entrega_id     UUID         NOT NULL REFERENCES ades_tareas_entregas(id) UNIQUE,
    rubrica_id           UUID         REFERENCES ades_rubricas(id),
...
COMMENT ON COLUMN ades_calificaciones_tareas.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_evaluaciones.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_calificaciones_evaluaciones.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_calificaciones_periodo.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_personal_salud.id IS 'Llave primaria UUID generada por uuidv7().';
SELECT auditoria.asignar_trigger('ades_personal_salud');

CREATE TABLE ades_expedientes_medicos (
    id                   UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    estudiante_id        UUID         NOT NULL REFERENCES ades_estudiantes(id) UNIQUE,
...
COMMENT ON COLUMN ades_expedientes_medicos.id IS 'Llave primaria UUID generada por uuidv7().';
SELECT auditoria.asignar_trigger('ades_expedientes_medicos');

CREATE TABLE ades_incidentes_medicos (
    id                      UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    estudiante_id           UUID         NOT NULL REFERENCES ades_estudiantes(id),
    personal_salud_id       UUID         REFERENCES ades_personal_salud(id),
...
COMMENT ON COLUMN ades_incidentes_medicos.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_reportes_conducta (
    ...
    estudiante_id         UUID         NOT NULL REFERENCES ades_estudiantes(id),
    grupo_id              UUID         NOT NULL REFERENCES ades_grupos(id),
    reportado_por_id      UUID         NOT NULL REFERENCES ades_profesores(id),
...
COMMENT ON COLUMN ades_reportes_conducta.id IS 'Llave primaria UUID generada por uuidv7().';
...
COMMENT ON COLUMN ades_reportes_academicos.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_comunicados (
    ...
    -- Alcance
    escuela_id           UUID         REFERENCES ades_escuelas(id),
...
COMMENT ON COLUMN ades_comunicados.id IS 'Llave primaria UUID generada por uuidv7().';
SELECT auditoria.asignar_trigger('ades_comunicados');

CREATE TABLE ades_acuses_comunicado (
    id                   UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    comunicado_id        UUID         NOT NULL REFERENCES ades_comunicados(id),
...
COMMENT ON COLUMN ades_acuses_comunicado.id IS 'Llave primaria UUID generada por uuidv7().';
...
CREATE TABLE ades_notificaciones (
    ...
    entidad_id           UUID,        -- FK polimórfica; tipo UUID para consistencia con PKs
...
COMMENT ON COLUMN ades_notificaciones.id IS 'Llave primaria UUID generada por uuidv7().';
COMMENT ON COLUMN ades_notificaciones.entidad_id IS 'FK polimórfica; almacena el id UUID del objeto origen de la notificación.';
...
CREATE TABLE ades_informacion_escuela (
    id                   UUID        NOT NULL DEFAULT uuidv7() PRIMARY KEY,
    escuela_id           UUID         NOT NULL REFERENCES ades_escuelas(id) UNIQUE,
    mision               TEXT,
    vision               TEXT,
    valores              TEXT,
    historia             TEXT,
...
COMMENT ON COLUMN ades_informacion_escuela.id IS 'Llave primaria UUID generada por uuidv7().';
...
--   - PKs migradas de BIGINT GENERATED ALWAYS AS IDENTITY a UUID NOT NULL DEFAULT uuidv7()
--   - Columnas FK migradas de BIGINT a UUID
--   - Referencias polimórficas (entidad_id) migradas de BIGINT a UUID
--   - Encabezado actualizado a PostgreSQL 18
--   - COMMENT ON id agregado en todas las tablas
-- =============================================================================
