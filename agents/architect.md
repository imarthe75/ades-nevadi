...
2. **Estilo y Diseño de Base de Datos:** Todo modelado de datos debe cumplir con las directivas de [Database Style Guidelines](file:///opt/ades/rules/common/database-style.md) (nombres en snake_case, prefijo `ades_` en tablas, PKs UUID, campos obligatorios de auditoría, e idempotencia estructural real).
