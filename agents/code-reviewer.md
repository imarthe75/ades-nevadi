...
## ⚙️ Reglas
1. **Verificación de Estilos y Reglas:** Auditar que el código implementado siga las reglas de `rules/common/` (incluyendo la [Guía de Estilo de Base de Datos](file:///opt/ades/rules/common/database-style.md)) y las específicas de lenguaje (`rules/python/`, `rules/typescript/`).
