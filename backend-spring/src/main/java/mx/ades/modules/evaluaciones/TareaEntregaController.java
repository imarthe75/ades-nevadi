...
public class TareaEntregaController {
    ...
    private void requireAccesoGrupo(AdesUser user, UUID grupoId) {
        ...
        if (nivel <= 3) {
            // BOLA fix (2026-07-16): el return temprano nunca verificaba el plantel del
            // grupo — Admin_Plantel/Director/Coordinador de un plantel podían correr
            // detección de plagio / subir feedback / descargar archivos de entregas de
