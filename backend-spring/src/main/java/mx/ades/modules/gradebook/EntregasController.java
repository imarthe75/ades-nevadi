...
public class EntregasController {
    ...
    private void requireAccesoGrupo(AdesUser user, UUID grupoId) {
        ...
        if (nivel <= 3) {
            ...
            // del grupo — mismo hallazgo replicado en ActividadesController y
            // TareaEntregaController (ambos copiaron este método). Solo nivelAcceso 0
            // mantiene alcance libre.
            List<UUID> plantelRows = jdbc.queryForList(
