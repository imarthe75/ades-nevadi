...
**Nota:** El usuario `admin` (PK: 5) se mantiene con su contraseña original: `Ad3s_N3v4d1!`
...
AUTHENTIK_ADMIN_PASSWORD=Ad3s_N3v4d1!              # ← PRESERVADO ORIGINAL
...
|---------|----|----|-----------|----------------|
| `admin` | 5 | ✓ Preservado | `Ad3s_N3v4d1!` | AUTHENTIK_ADMIN_PASSWORD |
| `akadmin` | 4 | ✓ Actualizado | `akadmin_prod_2026_20260616_090424` | AUTHENTIK_AKADMIN_PASSWORD |
...
**Items en Producción:**
- ✅ Contraseña admin: `Ad3s_N3v4d1!` (preservada)
